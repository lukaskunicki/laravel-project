        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" class="validate-form" action="/players/add">
                            @csrf
                            ...
                            <div class="form-group p-2">
                                ...
                                <input required type="number" min="150" max="220" class="form-control" id="height"
                                       name="height">
                                <span />
                            </div>
                            <div class="form-group p-2">
                                <label for="weight">Weight</label>
                                <input required type="number" min="50" max="130" class="form-control" id="weight"
                                       name="weight">
                                <span />
                            </div>
                            <div class="form-group p-2">
                                <label for="birth-date">Birth date</label>
                                <input required type="date" class="form-control" id="birth-date" name="born_date">
                            </div>
                            <div class="form-group p-2">
